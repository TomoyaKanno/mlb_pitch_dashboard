...
The GitHub workflow added in the next implementation phase will commit only a validated snapshot. GitHub Pages will separately receive an ephemeral build artifact.
