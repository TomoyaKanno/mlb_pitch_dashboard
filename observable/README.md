...
The Python data loader calls `pipeline.export`, which reloads and validates the durable snapshot before producing browser-ready team totals. The built site makes no MLB API calls and requires no runtime backend or database.
